...
variables_not_run = {
        ...
        'CLOUD': {
            ...
            'type': np.int16,
            'color': ['#0000ff', '#0021f7', '#003fee', '#005ce6','#008ed5', '#00a3cc', '#00b7c4', '#00bbaf','#00aa72', '#00a256', '#00993d', '#009127','#008000', '#239c00', '#39aa00', '#52b800','#8ed500', '#b0e300', '#d6f100', '#ffff00','#ffcc00', '#ffbb00', '#ffaa00', '#ff9900','#ff7700', '#ff6600', '#ff5500', '#ff4400','#ff2200', '#ff1100', '#ff0000'],
            'convert': 1000
        },
    }
variables = {
        ...
        'RH': {
            ...
            'type': np.int16,
            'color': ['#ff0000', '#ff1100', '#ff2200', '#ff3300','#ff5500', '#ff6600', '#ff7700', '#ff8800','#ffaa00', '#ffbb00', '#ffcc00', '#ffdd00','#ffff00', '#ffff00', '#d6f100', '#b0e300','#6ec700', '#52b800', '#39aa00', '#239c00','#008000', '#009127', '#00993d', '#00a256','#00b38f', '#00bbaf', '#00b7c4', '#00a3cc','#0076dd', '#005ce6', '#003fee', '#0021f7', '#0000ff'],
            'convert': 100
        },
        ...
        'PRECIP': {
            ...
            'type': np.int32,
            'color': ['#ffffff', '#e7e7d7', '#9fdf9f', '#58e7e7', '#0000ff', '#0000ff', '#0021f7','#005ce6', '#0076dd','#00a3cc', '#00b7c4','#00b38f', '#00aa72','#00993d', '#009127','#008000', '#239c00','#52b800', '#6ec700','#b0e300', '#d6f100','#ffdd00', '#ffcc00','#ffaa00', '#ff9900','#ff7700', '#ff6600','#ff4400', '#ff3300','#ff1100', '#ff0000'],
            'convert': 100
        },
